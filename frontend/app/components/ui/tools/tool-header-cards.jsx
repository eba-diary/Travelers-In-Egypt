import { Stack, Text, Image, Grid, GridItem, Button } from "@chakra-ui/react";
import { useRouter } from "next/router";

export default function ToolHeaderCards({ data }) {
        ...
        <Stack width='100%' alignItems='center'>
            <Stack width='90%'>
                ...
                <Grid templateColumns='repeat(3, 1fr)' gap='50px'>
                    {data.fields.toolHeaderCards.map((entry, index) => (
                        <GridItem key={index}>
                            <Stack
                                width='100%'
                                alignItems='center'
