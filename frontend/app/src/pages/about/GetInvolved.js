...
function GetInvolved() {
    let pageContent =
        <div className="row justify-content-left">
            <div className="col-6">
                <div className="donation__text card card-body">
                    <div>Our ongoing work relies on the generosity of our supporters.
                        ...
                        Your investment in our work goes a long way! Thank you.</div>
                </div>
            </div>
        </div>;
...
// header, image become scaling, include better text, lower background to fit footer and header/
function DonationBackdrop() {
    return (
        <div className="row">
            <Col>
                <div className='cardimg__donation'>
                    <Card inverse>
                        <CardImg
                            alt="donation image"
