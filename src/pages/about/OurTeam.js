...
function OurTeam() {
    return (
        ...
        <div className="container">
            <Row>
                <Col>
                    <Card>
                        <CardBody>
                        {/* <CardImg alt="Sarah Ketchley" src={placeholder} width='25%'/> */}
                        <CardTitle tag='h2' body="true" className="text-center">
                            Project Director
                        </CardTitle>
                        ...
                        <CardText>
                            ...
                            <p className="director-paragraph">
                            <a href="https://twitter.com/SarahKetchley">@sarahketchley</a> ketchley@uw.edu
                        </p>
                        </CardText>
                        </CardBody>
                    </Card>
        ...
        <div className="container student-team">
                <div className="row">
                    <div className="col">
                        <h2 className='text-center'>Student Contributors</h2>
                    </div>
                </div>
                <div>
                <Row>
